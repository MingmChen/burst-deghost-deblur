...
class SythesizeBlur(nn.Module):
    def __init__(self):
        ...
        self.maxpool1 = nn.MaxPool2d(kernel_size=2,stride=2,padding=1) # kernel size ?
        ...
        self.maxpool2 = nn.MaxPool2d(kernel_size=2, stride=2, padding=1) # kernel size ?
        ...
        self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=1) # kernel size ?
        ...
        self.maxpool4 = nn.MaxPool2d(kernel_size=2, stride=2, padding=1)  # kernel size ?
        ...
        self.weight1 = nn.Conv2d(32, 17, kernel_size=1, stride=1, padding=0) # padding?
        self.weight2 = nn.Conv2d(32, 17, kernel_size=1, stride=1, padding=0) # padding?
